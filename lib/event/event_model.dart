...
// models.dart dùng để định nghĩa các lớp
class EventModel {
  String? id;
  DateTime startTime;
  DateTime endTime;
...
// Định nghĩa tiện ích ExtVentModel trên lớp EventModel để mở rộng tính năng của lớp EventModel
// không cần tạo lớp mới
extension ExtVentModel on EventModel {
  // Trả về chuỗi định dạng thời gian bắt đầu và kết thúc
